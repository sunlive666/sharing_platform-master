...
void _help()
{
    printf("Using:/myproject/tools/bin/dminingoracle logfilename xmlbuffer\n\n");

    printf("Sample:/myproject/tools/bin/procctl 3600 /myproject/tools/bin/dminingoracle /myproject/log/idc/dminingoracle_ZHOBTCODE.log "
              ...
              "<bfilename>ZHOBTCODE</bfilename><efilename>togxpt</efilename><outpath>/myproject/dataFile/idc/dmindata</outpath>"\
              "<timeout>30</timeout><pname>dminingoracle_ZHOBTCODE</pname>\"\n\n");
    printf("       /myproject/tools/bin/procctl   30 /myproject/tools/bin/dminingoracle /myproject/log/idc/dminingoracle_ZHOBTMIND.log "\
              "\"<connstr>idc/idcpwd@snorcl11g_128</connstr><charset>Simplified Chinese_China.AL32UTF8</charset>"\
              ...
              "<bfilename>ZHOBTMIND</bfilename><efilename>togxpt</efilename><outpath>/myproject/dataFile/idc/dmindata</outpath>"\
              "<starttime></starttime><incfield>keyid</incfield>"\
              "<incfilename>/myproject/dataFile/idc/dmining/dminingoracle_ZHOBTMIND_togxpt.keyid</incfilename>"\
