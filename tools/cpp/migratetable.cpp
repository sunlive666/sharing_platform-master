...
void _help()
{
    printf("Using:/myproject/tools/bin/migratetable logfilename xmlbuffer\n\n");

    printf("Sample:/myproject/tools/bin/procctl 3600 /myproject/tools/bin/migratetable /myproject/log/idc/migratetable_ZHOBTMIND1.log "\
