...
int main(int argc,char *argv[])
{
    if (argc != 3)
    {
        ...
        printf("Sample:./webserver /myproject/log/idc/webserver.log 5088\n\n");
        printf("        /myproject/tools/bin/procctl 5 /myproject/tools/bin/webserver /myproject/log/idc/webserver.log 5088\n\n");
