...
{
    printf("Using:/myproject/tools/bin/xmltodb logfilename xmlbuffer\n\n");

    printf("Sample:/myproject/tools/bin/procctl 10 /myproject/tools/bin/xmltodb /myproject/log/idc/xmltodb_vip.log "\
              "\"<connstr>idc/idcpwd@snorcl11g_128</connstr><charset>Simplified Chinese_China.AL32UTF8</charset>"\
              "<inifilename>/myproject/idc/ini/xmltodb.xml</inifilename>"\
              "<xmlpath>/myproject/myserver/surfdata</xmlpath><xmlpathbak>/myproject/myserver/surfdataBak</xmlpathbak>"\
              "<xmlpatherr>/myproject/myserver/surfdataFail</xmlpatherr>"\
              "<timetvl>20</timetvl><timeout>50</timeout><pname>xmltodb_vip</pname>\"\n\n");
