...
void _help()
{
    printf("Using:/myproject/tools/bin/deletetable logfilename xmlbuffer\n\n");

    printf("Sample:/myproject/tools/bin/procctl 3600 /myproject/tools/bin/deletetable /myproject/log/idc/deletetable_ZHOBTMIND1.log "\
