/****************************************************************************************
 *   程序名：deletefiles.cpp，此程序是工具程序，用于删除历史的数据文件或日志文件。      
*****************************************************************************************/
#include "_public.h"
using namespace idc;
...
int main(int argc,char *argv[])
{
    ...
    {
        printf("\n");
        printf("Using:/myproject/tools/bin/deletefiles pathname matchstr timeout\n\n");

        printf("Example:/myproject/tools/bin/deletefiles /myproject/dataFile/idc/surfdata \"*.xml,*.json,*csv\" 0.01\n");
        cout << R"(        /myproject/tools/bin/deletefiles /myproject/log/idc "*.log.20*" 0.02)" << endl;
        printf("        /myproject/tools/bin/procctl 300 /myproject/tools/bin/deletefiles /myproject/log/idc \"*.log.20*\" 0.02\n");
        printf("        /myproject/tools/bin/procctl 300 /myproject/tools/bin/deletefiles /myproject/dataFile/idc/surfdata \"*.xml,*.json,*csv\" 0.02\n\n");
