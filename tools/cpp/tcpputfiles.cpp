...
{
    printf("\n");
    printf("Using:/myproject/tools/bin/tcpputfiles logfilename xmlbuffer\n\n");

    printf("Sample:/myproject/tools/bin/procctl 20 /myproject/tools/bin/tcpputfiles /myproject/log/idc/tcpputfiles_surfdata.log "\
              "\"<ip>192.168.19.128</ip><port>5005</port>"\
              "<clientpath>/myproject/dataFile/idc/surfdata</clientpath><ptype>1</ptype>"
              "<srvpath>/myproject/myserver/surfdata</srvpath>"\
              "<andchild>false</andchild><matchname>*.xml</matchname><timetvl>30</timetvl>"\
