...
void _help()
{
    printf("Using:/myproject/tools/bin/syncref logfilename xmlbuffer\n\n");

    printf("不分批同步，把T_ZHOBTCODE1@db128同步到T_ZHOBTCODE2。\n");
    printf("Sample:/myproject/tools/bin/procctl 10 /myproject/tools/bin/syncref /myproject/log/idc/syncref_ZHOBTCODE2.log "\
    ...
    printf("       /myproject/tools/bin/procctl 10 /myproject/tools/bin/syncref /myproject/log/idc/syncref_ZHOBTCODE3.log "\
              "\"<localconnstr>idc/idcpwd@snorcl11g_128</localconnstr><charset>Simplified Chinese_China.AL32UTF8</charset>"\
    ...
    printf("       /myproject/tools/bin/procctl 10 /myproject/tools/bin/syncref /myproject/log/idc/syncref_ZHOBTMIND2.log "\
              "\"<localconnstr>idc/idcpwd@snorcl11g_128</localconnstr><charset>Simplified Chinese_China.AL32UTF8</charset>"\
