...
int main(int argc,char *argv[])
{
    ...
    if (argc!=5)
    {
        ...
        cout << "Examples:/myproject/tools/bin/procctl 60 /myproject/idc/bin/crtsurfdata /myproject/idc/ini/stcode.ini /myproject/dataFile/idc/surfdata /myproject/log/idc/crtsurfdata.log csv,xml,json\n\n";
